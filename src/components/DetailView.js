        ...
        return (
            <View>
                <ScrollView showsVerticalScrollIndicator={false}>
                    <View>
                    <Button textColor={'#ffffff'} style={{backgroundColor: '#c64c38'}} icon="arrow-left" mode="text" onPress={() => noneSelected()}>
                        Back
                    </Button> 
                    </View>
                    <View>
                    ...
                    <View style={styles.personMetaInfoContainer}>
                        <Card>
                            ...
                            <Card.Actions style={styles.editDeleteButtonsContainer}>
                                <Button textColor={'#941a1d'} onPress={this.onDeletePress.bind(this)}>Delete</Button>
                                <Button textColor={'#ffffff'} style={{backgroundColor: '#c64c38'}} onPress={this.onEditPress.bind(this)}>Edit</Button>
                            </Card.Actions>
                        </Card>
                    </View>
                    <View style={styles.actionButtonContainerRoot}>
                        <View style={styles.actionButtonContainer}>
                            <Button textColor={'#ffffff'} style={{backgroundColor: '#c64c38'}} icon="phone" mode="contained" onPress={() => console.log('Pressed')}>
                                Call
                            </Button>
                        </View>
                        <View style={styles.actionButtonContainer}>
                            <Button textColor={'#ffffff'} style={{backgroundColor: '#c64c38'}} icon="email" mode="contained" onPress={() => console.log('Pressed')}>
                                E-mail
                            </Button>
                        </View>
                        <View style={styles.actionButtonContainer}>
                            <Button textColor={'#ffffff'} style={{backgroundColor: '#c64c38'}} icon="message-alert" mode="contained" onPress={() => console.log('Pressed')}>
                                SMS
                            </Button>
                        </View>
                    </View>
