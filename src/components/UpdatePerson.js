            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                <View style={styles.form}>
                    ...
                    <View style={styles.updateButton}>
                        <Button textColor={'#ffffff'} style={{backgroundColor: '#c64c38'}} mode="contained" onPress={this.onUpdatePress.bind(this)}>
                            Update
                        </Button>
                    </View>
                    <View style={styles.updateButton}>
                        <Button textColor={'#ffffff'} style={{backgroundColor: '#c64c38'}} mode="contained" onPress={this.onCancelPress.bind(this)}>
                            Cancel
                        </Button>
                    </View>                   
                </View>
